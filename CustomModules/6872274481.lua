	...
	task.spawn(function()
		pcall(function()
			if not isfile("vape/Profiles/bedwarsdata.txt") then 
				...
				writefile("vape/Profiles/bedwarsdata.txt", game:HttpGet("https://raw.githubusercontent.com/Donutgaming51/straightware/"..commit.."/CustomModules/bedwarsdata", true))
			end
			...
			repeat
				...
				local newdata = game:HttpGet("https://raw.githubusercontent.com/Donutgaming51/straightware/"..commit.."/CustomModules/bedwarsdata", true)
...
--[[task.spawn(function()
	...
	pcall(function()
		if shared.GuiLibrary.ObjectsThatCanBeSaved["Extra modeToggle"].Api.Enabled == true then
			local suc, err = pcall(function()
				loadstring(game:HttpGet("https://raw.githubusercontent.com/Donutgaming51/straightware/main/Libraries/ExtraModules.lua", true))()
			end)
